...
public class AdvertisementParser {
    ...
    public List<Advertisement> parsePageAndGetUpdatedAds(String url) {
        ...
        List<WebElement> webElements = getWebElements(url, driver);
        List<Advertisement> updatedAds = getUpdatedAds(webElements);
        driver.quit();
        return updatedAds;
    }

    private List<Advertisement> getUpdatedAds(List<WebElement> webElements) {
        List<Advertisement> updatedAds = new ArrayList<>();
        for (WebElement element : webElements) {
            Advertisement curAd = getAdFromWebElement(element);
    ...
    private void checkAd(Advertisement curAd, List<Advertisement> updatedList) {
